...
const TOWERS = [
  ...
  },
  {
    ...
    slowTime: 1.7,
    place: 'nearPath',
    placeNote: 'Short emitters — must sit within one tile of the road.',
  ...
  },
  {
    ...
    chainRange: 2.1,
    place: 'nearRock',
    placeNote: 'Needs grounding — must be built beside a rock outcrop.',
  ...
  },
  {
    ...
    splash: 1.45,
    place: 'farPath',
    placeNote: 'Deep emplacement — must be two or more tiles off the road.',
